...
VL_ATTR_COLD void Vtb_pe___024root___eval_initial__TOP(Vtb_pe___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_pe__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_pe___024root___eval_initial__TOP\n"); );
    // Body
...
VL_ATTR_COLD void Vtb_pe___024root___dump_triggers__act(Vtb_pe___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_pe.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_pe___024root___dump_triggers__nba(Vtb_pe___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_pe.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_pe___024root___ctor_var_reset(Vtb_pe___024root* vlSelf) {
    ...
    vlSelf->tb_pe__DOT__en = VL_RAND_RESET_I(1);
    vlSelf->tb_pe__DOT__a_in = VL_RAND_RESET_I(8);
    vlSelf->tb_pe__DOT__b_in = VL_RAND_RESET_I(8);
    vlSelf->tb_pe__DOT__a_out = VL_RAND_RESET_I(8);
    vlSelf->tb_pe__DOT__b_out = VL_RAND_RESET_I(8);
    vlSelf->tb_pe__DOT__acc_out = VL_RAND_RESET_I(32);
    vlSelf->__Vdlyvval__tb_pe__DOT__clk__v0 = VL_RAND_RESET_I(1);
    vlSelf->__Vdlyvset__tb_pe__DOT__clk__v0 = 0;

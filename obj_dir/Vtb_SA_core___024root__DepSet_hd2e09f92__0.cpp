...
void Vtb_SA_core___024root___eval_triggers__act(Vtb_SA_core___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_SA_core___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->tb_SA_core__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_SA_core__DOT__clk__0))));
    vlSelf->__VactTriggered.set(1U, vlSelf->__VdlySched.awaitingCurrentTime());
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->tb_SA_core__DOT__done) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_SA_core__DOT__done__0)));

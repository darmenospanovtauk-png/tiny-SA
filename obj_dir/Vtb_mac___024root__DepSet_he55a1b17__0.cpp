...
void Vtb_mac___024root___eval_initial(Vtb_mac___024root* vlSelf) {
    ...
    // Body
    Vtb_mac___024root___eval_initial__TOP(vlSelf);
...
VL_INLINE_OPT void Vtb_mac___024root___nba_sequent__TOP__1(Vtb_mac___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_mac__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_mac___024root___nba_sequent__TOP__1\n"); );
    // Body
...
void Vtb_mac___024root___eval_nba(Vtb_mac___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtb_mac___024root___nba_sequent__TOP__1(vlSelf);
    }
}
